...
function UsersTab() {
  ...
  const isModuleFull = (modId: string) => {
    return (
      selectedPerms.includes('*') ||
      selectedPerms.includes(`${modId}.*`) ||
      (selectedPerms.includes(`${modId}.read`) && selectedPerms.includes(`${modId}.write`))
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Granular Module Permissions Manager Modal */}
      <PlerosDialogModal
        open={!!permsUser}
