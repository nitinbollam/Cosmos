  ...
  return (
    <div style={{ padding: 24, display: 'flex', gap: 24, flexWrap: 'wrap', maxWidth: 1100, margin: '0 auto' }}>
      <div style={{ flex: '2 1 400px' }}>
        ...
        <Link href="/catalog" style={{ color: 'var(--c-accent)', display: 'inline-block', marginTop: 16 }}>
          Continue shopping
        </Link>
      </div>
      <aside className="cosmos-card" style={{ flex: '1 1 260px', alignSelf: 'flex-start' }}>
        ...
        <Link href="/checkout" className="btn-primary" style={{ textDecoration: 'none', width: '100%', display: 'block', textAlign: 'center' }}>
          Proceed to Checkout
        </Link>
