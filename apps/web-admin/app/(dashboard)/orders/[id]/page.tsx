...
export default function OrderDetailPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl">
      <Link href="/orders" className="text-sm text-cosmos-accent hover:underline">
        ← Orders
      </Link>
          ...
          {task && (
            <div className="cosmos-card">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-3">
                ...
                <Link href={`/fulfillment/${encodeURIComponent(task.id)}`} className="text-sm text-cosmos-accent hover:underline">
                  Open pick task →
                </Link>
              </div>
