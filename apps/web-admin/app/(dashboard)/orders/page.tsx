                ...
                {rows.map((o) => (
                  <tr key={o.id}>
                    <td className="font-mono text-sm">
                      <Link href={`/orders/${encodeURIComponent(o.id)}`} className="text-cosmos-accent hover:underline">
                        #{o.id.slice(-10)}
                      </Link>
                    </td>
                    ...
                    <td className="whitespace-nowrap">
                      <Link href={`/orders/${encodeURIComponent(o.id)}`} className="btn-ghost !py-1 !px-2 !text-xs mr-1 inline-block">
                        View
                      </Link>
