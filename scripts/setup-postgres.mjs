...
PLEROS_DB_PROVIDER=postgres
DATABASE_URL=postgresql://pleros:pleros@localhost:5432/postgres

Then create logical databases (once):
  docker compose -f docker-compose.yml exec -T postgres psql -U pleros -d postgres < infra/sql/init-databases.sql
